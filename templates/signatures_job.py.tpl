...
applymapping1 = ApplyMapping.apply(
    ...
    mappings = [
      ...
      ("external_constituent_id", "string", "external_constituent_id", "string"),
      ...
      ("consent_content_version_id", "bigint", "consent_content_version_id", "bigint"),
